function DBTables_SERVER() {
	...
	#region TABLE: WALLETS
	#macro WALLETS_ACCID_SERVER 0
	#macro WALLETS_GOLD_SERVER 1
	#endregion
	
	#region TABLE: EQUIPMENTS
	#macro EQUIPMENTS_ACCID_SERVER 0
	#macro EQUIPMENTS_WEAPON_SERVER 1
	#endregion
}