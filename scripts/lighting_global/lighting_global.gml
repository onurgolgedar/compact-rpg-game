function lighting_global() {
	...
	global.lightUpdateFrameDelay = 100
...
#macro __SIGHT_LIGHT_SHADER sh_blend_light_sight
...
#macro __LIGHT_RENDERER contLightRenderer
	...
	enum eLightFlags {
		...
		//		 TLDR: If you remove this flag, always dirty the light when you change a render-only attribute on it
		CastsShadows = 1 << 1,
	...
	// If  then it uses the active view camera
