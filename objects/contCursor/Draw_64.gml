if (global.held_box != undefined) {
	if (global.held_from_assetName == object_get_name(objInventory_window) or global.held_from_assetName == object_get_name(objEquipments_window) or global.held_from_assetName == object_get_name(objTrade_window)) {
