...
if (is_mouse_on()) {
	...
	net_client_send(_CODE_CHANGE_ACTIVE_BOX, string(onBox_box.item.type)+"|undefined|undefined|"+get_box_confirmation_number_COMMON(onBox_box), BUFFER_TYPE_STRING)
}