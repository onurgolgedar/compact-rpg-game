if (collector == undefined) {
	with (objPlayer_SERVER) {
		if (point_distance(x, y, other.x, other.y) < 180) {
			...
			net_server_send(SOCKET_ID_ALL, CODE_COLLECT_COIN, json_stringify({ socketID: socketID, coinID: other.id, value: playerRow[? ACCOUNTINFO_GOLD_SERVER] }), BUFFER_TYPE_STRING)
			break
		}
	}
