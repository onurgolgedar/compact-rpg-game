...
if (is_mouse_on() and !is_click_blocked()) {
	...
	net_client_send(_CODE_BUY, string(onBox_box.item.type)+"|"+string(onBox_i)+"|"+string(onBox_j)+"|"+box_get_confirmation_number_COMMON(onBox_box)+"|"+string(owner.npcID)+"|undefined|undefined", BUFFER_TYPE_STRING)
}